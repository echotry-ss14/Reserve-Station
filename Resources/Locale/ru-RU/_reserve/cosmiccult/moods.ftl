...
thaven-mood-cosmic-fakemonument-desc = Перед вашим мысленным взором возникает огромная тень, силуэт вырисовывающегося строения. Монумент. Вы должны найти его или соорудить самостоятельно, любой ценой.
...
thaven-mood-cosmic-grotesqueworld-name = Спектакль
...
thaven-mood-cosmic-disregardoftheself-desc = Вы не заботитесь о своих собственных нуждах, какими бы ужасными они ни были. Вы все равно умрете.
...
thaven-mood-cosmic-painlessendings-desc = Вы стали свидетелями неминуемого конца, и это гораздо хуже, чем вы могли себе представить. Было бы добрым поступком не дать существам с низким интеллектом дожить до этого времени. Вы же не хотите, чтобы животные страдали, поэтому применяйте свои методы как можно более безболезненно.
