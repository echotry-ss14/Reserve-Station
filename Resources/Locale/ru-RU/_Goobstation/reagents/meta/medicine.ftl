...
reagent-desc-probital = Заставляет организм пациента тратить энергию на создание большего количества лекарств. Передозировка истощает организм, заставляя его, по сути, вздремнуть.
